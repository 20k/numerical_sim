...
buffer_set::buffer_set(cl::context& ctx, vec3i size, buffer_set_cfg cfg)
{
    ...
    std::vector<std::tuple<std::string, std::string, float, float, float, int>> values =
    {
        ...
        {"Dp_star", "evolve_hydro_all", 0.35, 0, 1, 1},
        {"De_star", "evolve_hydro_all", 0.35, 0, 1, 1},
        {"DcS0", "evolve_hydro_all", 0.35, 0, 1, 1},
        {"DcS1", "evolve_hydro_all", 0.35, 0, 1, 1},
        {"DcS2", "evolve_hydro_all", 0.35, 0, 1, 1},
